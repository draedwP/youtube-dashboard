...
async function main(){
 ...
 for(const handle of handles){
  ...
  channels.push({handle,id:c.id,title:c.snippet.title,subscribers,totalViews:views,increase48h:base?views-base.views:null,baselineAt:base?new Date(base.at).toISOString():null,latest});
 }
